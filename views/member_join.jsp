	...
	<div id="join_wrap">
		...
		<form name="f" method="post" action="member_join_ok.do"
			...
			<table id="join_t">
				...
				<tr>
					<th>나머지 주소</th>
					<td><input name="address2" id="address2" size="40"
						class="input_box" /></td>
				</tr>

				<tr>
					<th>휴대전화번호</th>
					<td><%@ include file="../views/include/phone_number.jsp"%>
						<select name="tel1">
							<c:forEach var="p" items="${phone}" begin="0" end="5">
								<option value="${p}">${p}</option>
							</c:forEach>
					</select>-<input name="tel2" id="tel2" size="4" maxlength="4"
						class="input_box" />-<input name="tel3" id="tel3" size="4"
						maxlength="4" class="input_box" /></td>
				</tr>

				<tr>
					<th>이메일</th>
					<td><input name="email" id="email" size="10" class="input_box" />@<input
