...
<script type="text/javascript">
	...
	function cook_add() {
		...
		str += "<tr>";
		str += "	<td>조리사진</td>";
		str += "	<td><input multiple=\"multiple\" type=\"file\" name='r_file1'";
		str += "onchange=\"readURL(this);\" id=\"r_file"+i+"\">";
	...
	//				document.getElementById('cookmain').src = e.target.result;
					document.getElementById('cook1').src = e.target.result;
				};
				reader.readAsDataURL(input.files[0]);
			} else {
	//			document.getElementById('cookmain').src = "";
				document.getElementById('cook1').src = "";
			}
		}
			...
			<table border=1>
				<tr>
					...
					<td><input type="file" multiple="multiple" id="r_file1" name="r_file1"
						onchange="readURL(this);">
						<img id="cook1" src="images/western.jpg" width=300 height=350 class="preview"/></td>
				</tr>
				<tr>
					<td>내용</td>
